                ...
                <div class="row">
                    ...
                    <div class="card-body">
                        <div class="profile-head">
                                    <h6>
                                       Dosen Fakultas <?php echo $this->session->userdata('id_fakultas'); ?>
                                    </h6>
                                            ...
                                            <div class="col-md-6">
                                                  ...
                                                  <form>                 
                                                        ...
                                                        <div class="form-group">
                                                          ...
                                                          <input type="text" name="kodedosen" class="form-control" id="exampleFormControlInput1" placeholder="Kode Dosen" value="<?php echo $this->session->userdata('kodedosen'); ?>" readonly>
                                                        </div>                                                      
                                                        <div class="form-group">
