                  ...
                  <table class="table">
                    ...
                    <?php if ($json->success): ?>
                      <?php if (count($json->data) > 0): ?>
                          <?php foreach($json->data as $absen): ?>
                            <tr>
                              <td><?php echo $absen->nip; ?></td>
                              <td><?php echo $absen->id_fakultas; ?></td>
                              <td><?php echo $absen->status; ?></td>
                              <td>
                               <?php echo form_open('indexadmin/updateabsensi'); ?> 
                                <input type="hidden" name="nip" value="<?php echo $absen->nip; ?>" required>
                                <input type="hidden" name="id_fakultas" value="<?php echo $absen->id_fakultas; ?>" required>
